...
*This post is also available in [English](/2026/02/18/the-first-step-en.html).*

Desde hace unos meses, una pregunta se me volvió recurrente: con un mundo cambiando a esta velocidad, ¿estoy dedicando mi tiempo a lo que de verdad importa? La rutina de un trabajo full-time te empuja a la ejecución constante, a optimizar el próximo sprint. Pero la sensación de estar en un punto de inflexión histórico —con la IA redefiniendo las reglas de juego— me generaba una disonancia cada vez mayor. Sentía la urgencia de parar la pelota, no para descansar, sino para poder pensar. Ahí entendí que el mayor riesgo no es dar un paso hacia lo incierto; el mayor riesgo es quedarse quieto, aplicando soluciones de ayer a los problemas de mañana.

Esta reflexión me llevó a tomar una decisión: dejo mi rol en una gran empresa para empezar un nuevo capítulo como consultor independiente. No es solo un cambio de trabajo, es una apuesta por un modelo distinto. Es la decisión de salir del silo para poder conectar ideas y volver a las comunidades que tanto me formaron.
