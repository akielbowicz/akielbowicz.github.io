...
GitHub: [@akielbowicz](https://github.com/akielbowicz)
...
**Licenciatura in Physics** | 2011 - 2017

*Thesis*: Statistical Analysis and Numerical Modeling of Single Particle Trajectories: Diffusion and Confinement Mechanisms

**10 Pines**
Software Engineering Certificate | 2018 - 2019

**Universidad del CEMA**
Advanced Risk and Portfolio Management (ARPM) | April 2021 - November 2021
...
**Quantitative Finance**: Multi-asset pricing, risk analytics, model calibration, curve construction, derivatives valuation
...
Active participant in technology conferences and meetups:
- Workshop presenter at SciPy Latinoamérica 2022 (Argentina)
- Regular speaker at local Python and Julia user groups
...
**Website**: [saxa.xyz](https://saxa.xyz/en)
**GitHub**: [@akielbowicz](https://github.com/akielbowicz)
**LinkedIn**: [linkedin.com/in/augusto-kiel](https://www.linkedin.com/in/augusto-kiel)

---

*Available for consulting engagements | Open to remote work globally and on-site in Buenos Aires*
